 ...
 */
class CRM_Participantletter_Upgrader_Base {

  /**
   * @var CRM_Participantletter_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Participantletter_Upgrader(
        'com.joineryhq.participantletter',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Participantletter_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Participantletter_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
